  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-30 py-8">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 border h-full flex flex-col">
          {/* Logo */}
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl
                  focus:border-gray-200 focus:ring-2 focus:ring-[#ede7f6] outline-none transition-all
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-300 text-[#7e57c2] focus:ring-[#9575cd]"
                  disabled={loading}
                />
              ...
              <button
                ...
                disabled={loading}
                className="text-xs font-medium text-[#7e57c2] hover:text-[#9575cd] transition-colors
            ...
            <button
              ...
              className="w-full bg-[#7e57c2] mt-2 text-white font-medium py-2.5
        ...
        <div className="rounded-3xl shadow-lg border p-5 relative overflow-hidden h-full flex flex-col">
          {/* Title */}
          <div className="flex items-center gap-3 mb-5">
            <div className="w-12 h-12 rounded-xl bg-white/40 backdrop-blur-sm flex items-center justify-center">
              <QrCode className="w-6 h-6 text-[#7e57c2]" />
            </div>
            <div>
              <h2 className="text-2xl font-extrabold text-[#7e57c2]">QR CODE LOGIN</h2>
          ...
          <div className="rounded-3xl py-5 m-4 mx-8 flex items-center justify-center">
            <QRCode value="EAARTH-STUDIOS-LOGIN" size={170} level="H" fgColor="#7e57c2" />
          </div>

          {/* How-To Steps */}
          <div className="space-y-3">
            <h3 className="font-medium text-sm mb-2 text-[#7e57c2]">How to use:</h3>
            ...
            {[
              ...
              <div className="flex items-center gap-3" key={i}>
                <div className="w-8 h-8 rounded-md bg-[#d1c4e9] flex items-center justify-center text-[#7e57c2] text-xs font-medium">
                  {i + 1}
                </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div className="text-center" key={text}>
                  <div className="w-10 h-10 mx-auto mb-2 bg-[#d1c4e9] rounded-xl flex items-center justify-center">
                    <Icon className="w-5 h-5 text-[#7e57c2]" />
                  </div>
                  <p className="text-[10px] font-medium text-[#7e57c2]">{text}</p>
                </div>
              ))}
            </div>
          </div>
