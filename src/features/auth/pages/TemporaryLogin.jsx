      ...
      <div className="flex items-center justify-between mb-6 gap-4">
        ...
        {(onSkip || !propEmail) && (
          <button
            ...
            className="flex items-center gap-2 px-4 md:px-5 py-2.5 bg-white border border-gray-200 text-[#7e57c2] rounded-xl hover:bg-[#ede7f6] transition-all font-medium text-sm md:text-base"
          >
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#9575cd] focus:border-transparent placeholder:text-gray-400 outline-none transition-all ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#9575cd] focus:border-transparent placeholder:text-gray-400 outline-none transition-all disabled:bg-gray-100"
                />
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#7e57c2] to-pink-600 text-white font-medium py-3.5 rounded-2xl mt-4 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
