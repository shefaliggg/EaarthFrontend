    ...
    <div className="w-full max-w-xl mx-auto px-4">
      ...
      <div className="flex items-center justify-between mb-6 gap-4">
        ...
        {(onSkip || !propEmail) && (
          <button
            ...
            className="flex items-center gap-2 px-4 md:px-5 py-2.5 bg-white border-2 border-purple-600 text-purple-600 rounded-xl hover:bg-purple-50 transition-all font-bold text-sm md:text-base"
          >
      ...
      <div className="w-full bg-white rounded-3xl shadow-xl overflow-hidden">
        <div className="px-6 md:px-10 py-8 text-center">
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">TEMPORARY LOGIN</h2>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder:text-gray-400 outline-none transition-all ${
            ...
            {/* Temp Password */}
            <div>
              <label className="block text-xs font-bold text-gray-600 mb-2">TEMPORARY PASSWORD *</label>
              <div className="relative">
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder:text-gray-400 outline-none transition-all disabled:bg-gray-100"
                />
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-3.5 rounded-3xl mt-4 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
