...
function ProjectCard({ project, index }) {
    ...
    return (
        <motion.div
            ...
            className="cursor-pointer rounded-2xl bg-background hover:bg-mint-50 dark:hover:bg-slate-950 border shadow-lg hover:shadow-md dark:shadow-shadow transition-all overflow-hidden"
        >
            {/* Project Content */}
                    ...
                    <div className="flex flex-wrap gap-2">
                        {project.studios.map((studio, i) => (
                            <Badge
                                variant={"secondary"}
                                key={i}
                            // className="px-3 py-1 rounded-lg text-xs font-medium bg-purple-100 dark:bg-gray-700 text-purple-800 dark:text-gray-300"
                            >
                                {studio}
                            </Badge>
                        ))}
