...
function ProjectActionListCard({ feature }) {
    ...
    return (
        <motion.div
            key={feature.id}
            className={`relative rounded-xl p-6 border transition-all cursor-pointer dark:hover:border-purple-500 bg-background hover:border-purple-400 hover:shadow-lg dark:shadow-shadow`}
