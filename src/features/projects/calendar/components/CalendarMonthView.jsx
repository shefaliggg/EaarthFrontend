                ...
                {weekDays.map((date) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        "flex gap-1 p-2 h-62 flex-col items-end cursor-pointer transition-all duration-200 border-r border-b border-primary/20 hover:bg-purple-50/60 dark:hover:bg-purple-900/20 overflow-hidden",
