...
const TABS = [
  { path: "details",              label: "Details",               progress: 100,                locked:true },
  { path: "contacts",             label: "Contacts",              progress: 100,                locked:true },
  { path: "dates",                label: "Dates",                 progress: 100,                locked:true },
  { path: "project",              label: "Project",               progress: 100,                locked:true },
  { path: "standard-crew",        label: "Standard Crew",         progress: 100,                locked:true },
  { path: "construction",         label: "Construction",          progress: 100,                locked:true },
  { path: "places",               label: "Places",                progress: 100,                locked:true },
  { path: "departments",          label: "Departments",           progress: 100,                locked:true },
  { path: "signatures-workflows", label: "Signatures & Workflow", progress: 91,                 locked:false },
  { path: "contracts-forms",      label: "Contracts & Forms",     progress: 63,                 locked:false },
  { path: "admin",                label: "Admin",                 progress: 47,                 locked:false },
  { path: "custom",               label: "Custom",                progress: 100,                locked:true },
  { path: "notifications",        label: "Notifications",         progress: 25,                 locked:false },
  { path: "timecard",             label: "Timecard",              progress: 100,                locked:true },
  { path: "subscriptions",        label: "Subscriptions",         progress: 38,                 locked:false },
  { path: "design-style",         label: "Design & Style",        progress: 96,                 locked:false },
  { path: "layout",               label: "Layout",                progress: 11,                 locked:false },
  { path: "app-settings",         label: "App Settings",          progress: 100,                locked:true },
  { path: "chat",                 label: "Chat",                  progress: 100,                locked:true },
  { path: "calendar",             label: "Calendar",              progress: 19,                 locked:false },
  { path: "ai-knowledge-base",    label: "AI Knowledge Base",     progress: 85,                 locked:false },
];
