...
export function ProjectList() {
  ...
  return (
    <div className="p-3 py-0 space-y-6">
      ...
      {/* Search Bar */}
      <div className="relative bg-white dark:bg-gray-800 rounded-xl border shadow-lg dark:shadow-shadow">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-2.5 rounded-2xl border-0 bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 font-medium focus:outline-none"
        />
