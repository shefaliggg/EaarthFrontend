...
export default function CreateOfferDialog({ open, onOpenChange }) {
  ...
  const handleCreateNewCompany = () => {
    ...
    const newCompany = { id: Date.now(), name: newCompanyName.trim() };
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-lg">
            {step === "country" ? (
              <><Building2 className="w-5 h-5 text-primary" />Select Country</>
            ) : step === "company" ? (
              <><Building2 className="w-5 h-5 text-primary" />Select Company</>
            ) : (
              <><Users className="w-5 h-5 text-primary" />Select Offer Type</>
            )}
          </DialogTitle>
          <DialogDescription>
            {step === "country"
            ...
            {countries.map((country) => (
              <button
                ...
                className={cn(
                  ...
                  "hover:bg-accent/10 flex items-center justify-between gap-3"
                )}
              >
        ...
        {step === "company" && (
          <div className="space-y-3 mt-2">
            ...
            <div className="p-2 rounded-lg bg-muted/10 flex items-center gap-2">
              ...
              <div className="p-3 rounded-lg border bg-muted/30 space-y-3">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    autoFocus
                    onKeyDown={(e) => { if (e.key === "Enter") handleCreateNewCompany(); }}
                  />
                  <Button size="sm" onClick={handleCreateNewCompany}>Add</Button>
                </div>
                <Button
        ...
        {step === "type" && (
          <div className="space-y-3 mt-2">
            ...
            <Card
              className="p-4 cursor-pointer hover:bg-accent/10 border-2 border-transparent hover:border-primary/20 transition-all"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <ChevronRight className="w-5 h-5 text-muted-foreground mt-2 shrink-0" />
              </div>
            </Card>
