...
export default function ConfirmActionDialog({
  ...
  const handleConfirm = async () => {
    if (requireReason && !reason)
      return toast.error("Please select a reason for this action.");
    if (requireNotes && !note)
      return toast.error("Please describe the reason for this action.");
  ...
  const variantStyles = {
    danger: {
      ...
      button:
        "bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 shadow-red-100",
    ...
    success: {
      ...
      button:
        "bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 shadow-emerald-100",
