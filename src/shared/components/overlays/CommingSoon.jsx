...
function CommingSoon({feature = "feature"}) {
    return (
        <div className={`absolute top-0 left-0 z-50 w-full rounded-2xl overflow-hidden h-full flex flex-col justify-center items-center backdrop-blur-xs bg-background/10`}>
